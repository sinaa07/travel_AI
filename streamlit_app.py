...
def travel_assistant(user_input):
    ...
    if not details_collected:
        ...
        **Rules:**
        ...
        - Keep your tone engaging and friendly.
        - Use emojis, but not too much.
        - Avoid repeating questions unnecessarily.
        - **Wait for user's response. DO NOT PROCEED WITHOUT USER'S NEXT RESPONSE.**
        - Once all details are collected, give user a structured summary of the trip and transition to activity suggestions.
        """
        ...
        - ONLY when the activities are confirmed by the user, move to itinerary generation.
        - **Do not generate itinerary without user confirmation.**
        """
    else:
        system_prompt = """
        ...
        - **If the user asks to book anything politely say that it is out of your scope.**
        """
